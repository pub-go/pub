...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.AuthorFid = field.NewString(tableName, "author_fid")
	_comment.AuthorName = field.NewString(tableName, "author_name")
	_comment.AuthorEmail = field.NewString(tableName, "author_email")
	_comment.AuthorURL = field.NewString(tableName, "author_url")
	_comment.Parent = field.NewUint(tableName, "parent")
	_comment.Depth = field.NewUint(tableName, "depth")
	_comment.PostID = field.NewUint(tableName, "post_id")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.AuthorFid = field.NewString(table, "author_fid")
	c.AuthorName = field.NewString(table, "author_name")
	c.AuthorEmail = field.NewString(table, "author_email")
	c.AuthorURL = field.NewString(table, "author_url")
	c.Parent = field.NewUint(table, "parent")
	c.Depth = field.NewUint(table, "depth")
	c.PostID = field.NewUint(table, "post_id")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["author_fid"] = c.AuthorFid
	c.fieldMap["author_name"] = c.AuthorName
	c.fieldMap["author_email"] = c.AuthorEmail
	c.fieldMap["author_url"] = c.AuthorURL
	c.fieldMap["parent"] = c.Parent
	c.fieldMap["depth"] = c.Depth
